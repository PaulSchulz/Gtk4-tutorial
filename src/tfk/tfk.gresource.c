...
# define SECTION __attribute__ ((section (".gresource.tfk"), aligned (8)))
#else
# define SECTION
#endif

static const SECTION union { const guint8 data[739]; const double alignment; void * const ptr;}  tfk_resource_data = {
  ...
  "\151\063\172\220\000\000\000\000\374\000\000\000\006\000\166\000"
  ...
  "\151\157\103\120\057\000\000\000\000\000\000\000\164\146\153\056"
...
static GStaticResource static_resource = { tfk_resource_data.data, sizeof (tfk_resource_data.data) - 1 /* nul terminator */, NULL, NULL, NULL };

G_MODULE_EXPORT
GResource *tfk_get_resource (void);
GResource *tfk_get_resource (void)
{
...
#ifdef G_DEFINE_CONSTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_CONSTRUCTOR_PRAGMA_ARGS(tfkresource_constructor)
#endif
G_DEFINE_CONSTRUCTOR(tfkresource_constructor)
#ifdef G_DEFINE_DESTRUCTOR_NEEDS_PRAGMA
#pragma G_DEFINE_DESTRUCTOR_PRAGMA_ARGS(tfkresource_destructor)
#endif
G_DEFINE_DESTRUCTOR(tfkresource_destructor)

#else
#warning "Constructor not supported on this compiler, linking in resources will not work"
#endif

static void tfkresource_constructor (void)
{
  g_static_resource_init (&static_resource);
}

static void tfkresource_destructor (void)
{
